...
def test_benchmark_transfer_guard_names_both_directions_of_the_same_error():
    """The Skorupski inversion (p ~= 0.62) is BMD-context. Carrying it onto an unsequenced breed or low-burden arm
    ...
    assert any("this breed" in item for item in guard["must_not_transfer_to"])
