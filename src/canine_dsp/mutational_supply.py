...
and mixed-treatment, and if the low-burden argument holds for Corgi HS specifically then 0.62 is a
...
CANINE_HS_EXOME = {
    ...
    "caveat": "n=5, and the 35 mutations are a Sanger-validated subset after filtering, not a "
             ...
             "not specified, so this says nothing about Corgi HS specifically. This is the entire "
...
def refuse_bmd_benchmark_transfer(implied_bmd_preexisting_prob: float = 0.62) -> dict:
    ...
    return {
        ...
        "symmetry_note": "This is the same class of error as applying BMD's 44/96 driver frequency "
                        "to a Corgi, which driver_conditioned_arms was rewritten to refuse. It ran "
